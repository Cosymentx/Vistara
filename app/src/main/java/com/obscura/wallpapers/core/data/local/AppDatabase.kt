 ...
 */
@Database(
    entities = [_root_ide_package_.com.obscura.wallpapers.core.data.model.Wallpaper::class, _root_ide_package_.com.obscura.wallpapers.core.data.model.AutoChangeHistory::class, _root_ide_package_.com.obscura.wallpapers.core.data.model.DiamondAccount::class, _root_ide_package_.com.obscura.wallpapers.core.data.model.DiamondTransaction::class],
    version = 6,
    exportSchema = false
)
